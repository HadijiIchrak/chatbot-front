...
ngOnInit() {
    ...
    this.accountForm = this.fb.group({
      ...
      this.form = this.formBuilder.group({
        from_account_number: ['', Validators.required],
        to_account_number: ['', Validators.required],
      ...
      if (!this.isAddMode) {
          this.transactionService.getbyid(this.id)
              // .pipe(first()) 
    ...
    public getAccountarray(): void {
        this.transactionService.getAccountarrayAdmin()
        .subscribe(
          data => {
            this.accounts=data;
      ...
      onSubmit() {
        ...
        this.alertService.clear();
          ...
          // stop here if form is invalid // problem hné
      ...
      private createTransaction() {
          this.transactionService.createTransactionAdmin(this.form.value)
            
              .subscribe(() => {
                  this.alertService.success('Transaction added', { keepAfterRouteChange: true });
